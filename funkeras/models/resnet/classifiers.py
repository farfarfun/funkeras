...
from funkeras.models.resnet import core as models
...
class ResNet18Classifier(Model):
    ...
    Usage:
        >>> from funkeras.models.resnet.classifiers import ResNet18Classifier
...
class ResNet34Classifier(Model):
    ...
    Usage:
        >>> from funkeras.models.resnet.classifiers import ResNet34Classifier
        >>> shape, classes = (224, 224, 3), 1000
        >>> x = keras.layers.Input(shape)
...
class ResNet50Classifier(Model):
    ...
    Usage:
        ...
        >>> from funkeras.models.resnet.classifiers import ResNet50Classifier
        >>> shape, classes = (224, 224, 3), 1000
        >>> x = keras.layers.Input(shape)
...
class ResNet101Classifier(Model):
    ...
    Usage:
        >>> from funkeras.models.resnet.classifiers import ResNet101Classifier
        >>> shape, classes = (224, 224, 3), 1000
        >>> x = keras.layers.Input(shape)
...
class ResNet152Classifier(Model):
    ...
    Usage:
        >>> from funkeras.models.resnet.classifiers import ResNet152Classifier
        >>> shape, classes = (224, 224, 3), 1000
        >>> x = keras.layers.Input(shape)
...
class ResNet200Classifier(Model):
    ...
    Usage:
        >>> from funkeras.models.resnet.classifiers import ResNet200Classifier
        >>> shape, classes = (224, 224, 3), 1000
        >>> x = keras.layers.Input(shape)
