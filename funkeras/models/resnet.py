...
from funkeras.utils import compose
...
class ResNetIdentityBlock(Component):
    ...
    def build(self, input_shape):
        ...
        self.conv2 = Conv2D(filters2, self.kernel_size, padding='same', kernel_initializer='he_normal',
...
class ResNetConvBlock(Component):
    ...
    def build(self, input_shape):
        ...
        self.conv1 = Conv2D(filters1, (1, 1), strides=self.strides, kernel_initializer='he_normal',
        ...
        self.conv4 = Conv2D(filters3, (1, 1), strides=self.strides, kernel_initializer='he_normal',
...
def VGGFace(include_top=True, model='vgg16', weights='vggface', input_tensor=None, input_shape=None, pooling=None,
    ...
    if model == 'resnet50':
        ...
        model = ResNet50Model(include_top=include_top, input_tensor=input_tensor, input_shape=input_shape,
