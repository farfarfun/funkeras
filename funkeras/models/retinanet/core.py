...
def backbone(backbone_name):
    ...
    if 'densenet' in backbone_name:
        from funkeras.models.retinanet.models.densenet import DenseNetBackbone as b
    elif 'seresnext' in backbone_name or 'seresnet' in backbone_name or 'senet' in backbone_name:
        from funkeras.models.retinanet.models.senet import SeBackbone as b
    elif 'resnet' in backbone_name:
        from funkeras.models.retinanet.models.resnet import ResNetBackbone as b
    elif 'mobilenet' in backbone_name:
        from funkeras.models.retinanet.models.mobilenet import MobileNetBackbone as b
    elif 'vgg' in backbone_name:
        from funkeras.models.retinanet.models.vgg import VGGBackbone as b
    elif 'EfficientNet' in backbone_name:
        from funkeras.models.retinanet.models.effnet import EfficientNetBackbone as b
    else:
