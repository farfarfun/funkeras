...
from notekeras.input import build_input_features, SparseFeat, DenseFeat, VarLenSparseFeat, create_embedding_matrix, \
    embedding_lookup, get_dense_input, get_varlen_pooling_list, varlen_embedding_lookup, combined_dnn_input
...
# from ..inputs import build_input_features, create_embedding_matrix, SparseFeat, VarLenSparseFeat, DenseFeat, \
#     embedding_lookup, get_dense_input, varlen_embedding_lookup, get_varlen_pooling_list, combined_dnn_input
