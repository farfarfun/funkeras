...
class EncoderComponent(keras.layers.Layer):
    def __init__(self,
        ...
        self.attention_layer1 = self.attention_layer2

    def build(self, input_shape):
        attention_name = '%s-MultiHeadSelfAttention' % self.name
        feed_forward_name = '%s-FeedForward' % self.name

        self.attention_layer1 = MultiHeadAttention(name=attention_name,
        ...
        self.attention_layer2 = WrapLayer(name=attention_name,
    ...
    def call(self, inputs, **kwargs):
        ...
        feed1 = self.feed_forward_layer1(inputs)
        feed2 = self.feed_forward_layer2(inputs)
